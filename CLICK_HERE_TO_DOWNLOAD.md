...
# Wait 3-5 min
# Find EXE in folder: release\JoeBrowser-Setup-1.0.0.exe  <-- HERE IS YOUR EXE!
```
...
3. Open folder `release` -> you have:
   - JoeBrowser-Setup-1.0.0.exe (installer, recommended)
   - JoeBrowser-Portable-1.0.0.exe (no install)
